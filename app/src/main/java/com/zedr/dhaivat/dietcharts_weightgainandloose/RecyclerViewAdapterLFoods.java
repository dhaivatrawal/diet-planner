...
class RecyclerViewAdapterLFoods extends RecyclerView.Adapter<RecyclerViewAdapterLFoods.ClubViewHolder>{


    List<LFoods.Club> clubs;

   public RecyclerViewAdapterLFoods(List<LFoods.Club> clubs){
        this.clubs=clubs;
    }
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterLFoods.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterLFoods.ClubViewHolder holder, int position) {
