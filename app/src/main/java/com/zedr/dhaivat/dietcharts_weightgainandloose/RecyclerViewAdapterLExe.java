...
class RecyclerViewAdapterLExe extends RecyclerView.Adapter<RecyclerViewAdapterLExe.ClubViewHolder>{


    List<LExercise.Club> clubs;

   public RecyclerViewAdapterLExe(List<LExercise.Club> clubs){
        this.clubs=clubs;
    }
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterLExe.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterLExe.ClubViewHolder holder, int position) {
