...
class RecyclerViewAdapterLHabits extends RecyclerView.Adapter<RecyclerViewAdapterLHabits.ClubViewHolder>{


    List<LHabits.Club> clubs;

   public RecyclerViewAdapterLHabits(List<LHabits.Club> clubs){
        this.clubs=clubs;
    }
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterLHabits.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterLHabits.ClubViewHolder holder, int position) {
